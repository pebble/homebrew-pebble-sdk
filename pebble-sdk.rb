class PebbleSdk < Formula
  ...
  devel do
    version PebbleSdk::Version.new("4.1.1-rc2")
    url 'https://github.com/pebble/pebble-tool/archive/v4.1.1-rc2.zip'
    sha256 '6221a1e0e18e01554dcf07afd2e67aa33b11756e2843a6344e1a90b7f143843a'
  end
