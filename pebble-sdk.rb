class PebbleSdk < Formula
  ...
  devel do
    version PebbleSdk::Version.new("4.1.1-rc1")
    url 'https://github.com/pebble/pebble-tool/archive/v4.1.1-rc1.zip'
    sha256 'd3c5484d099e94881ae29135b7b30b067ab47a149403497554f44f32185c06d7'
  end
