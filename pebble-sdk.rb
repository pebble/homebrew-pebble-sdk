class PebbleSdk < Formula
  ...
  devel do
    version PebbleSdk::Version.new("4.0-rc4")
    url 'https://github.com/pebble/pebble-tool/archive/v4.0-rc4.zip'
    sha256 'c341115a29ebd17f4df7d3f38349a668ebd8c4c80116fa9d4a9a49cdbae4de84'
