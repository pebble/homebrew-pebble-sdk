class PebbleSdk < Formula
  ...
  devel do
    version PebbleSdk::Version.new("4.2-rc1")
    url 'https://github.com/pebble/pebble-tool/archive/v4.2-rc1.zip'
    sha256 '0fd4f403566ac67b7a2ed055e2342f51b42acc66fc9071361857b60b418d0336'
  end
