class PebbleSdk < Formula
  ...
  stable do
    version PebbleSdk::Version.new("4.4")
    url 'https://github.com/pebble/pebble-tool/archive/v4.4.zip'
    sha256 '056a1088084d38edd5bde5dd7bdccea3b71966e44023cc2ff9a1b918084a49c3'
  end
